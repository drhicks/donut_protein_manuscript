...
<FILTERS>
    ...
    <RepeatParameter name="radius" param_type="radius" numb_repeats="20" min="0" max="99999999" confidence="1"/> #replace with correct number of repeats
    <RepeatParameter name="rise" param_type="rise" numb_repeats="20" min="0" max="99999999" confidence="1"/>
    <RepeatParameter name="twist" param_type="omega" numb_repeats="20" min="0" max="99999999" confidence="1"/>
</FILTERS>
<MOVERS>
...
def copy_necessary_files(name):
    os.system("cp rd1_files/flags_20 " + name + "/flags")
